...
//     echo "params.DEPLOY: ${params.DEPLOY} -- params.BRANCH_PORTAL_CLIENT: ${params.BRANCH_PORTAL_CLIENT} -- params.LAMBDAS: ${params.LAMBDAS}"
    ...
    environment {
        ENV_DEPLOY = sh(script:"echo ${params.DEPLOY}", returnStdout: true)
        ENV_BRANCH = sh(script:"echo ${params.BRANCH_PORTAL_CLIENT}", returnStdout: true)
        ENV_LAMBDAS = sh(script:"echo ${params.LAMBDAS}", returnStdout: true)
    }
    options { 
        timestamps()
        ansiColor('xterm')
